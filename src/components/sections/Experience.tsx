export default function ExperiencePage() {
  return (
    <section className="pt-12" id="experiencia">
      <h1 className="font-medium text-2xl tracking-tighter dark:text-white text-neutral-800">Experiencia</h1>
      <div className="prose prose-neutral dark:prose-invert mt-4">
        <div className="mt-6 flex justify-between items-center">
          <h2 className="font-medium text-xl mb-1 tracking-tighter dark:text-white text-neutral-800">
        ...
        <p className="text-neutral-600 dark:text-neutral-400 text-sm ">PBPlus</p>
